#code altered by ian P and conner c
import math
import nav_msgs.msg
import std_msgs.msg
...
def main():
    ...
    with open('/home/ubuntu/turtlebot4_ws/src/CC_HallwayScan/CC_HallwayScan/RISLlab_nomove_walking.csv', 'w', newline='') as file:
        ...
        for i in range(500): #move 3 meters forward
            print('move!')
            time.sleep(.050)
            transfrom_capture(tf_listener, writer)
            
            #watch human move over 
